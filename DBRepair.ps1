...
.DESCRIPTION
  A script to check and repair common errors with the Plex Media Server database.
.PARAMETER <Parameter_Name>
    <Add parameters as applicable, duplicate as needed>
.INPUTS
...
.NOTES
  Version:        1.0.1
  Author:         ChuckPa,Berserkir-Wolf
  Creation Date:  28-Mar-2023
  Purpose/Change: Plex Database Repair
.EXAMPLE
...
ShowMenu=1
#endregion
#region Universal output function
Output() {
...
#endregion
#region Check given database file integrity
CheckDB() {
...
#endregion
#region Return list of database backup dates for consideration in replace action
GetDates(){
...
#endregion
#region Non-fatal SQLite error code check
SQLiteOK() {
...
#endregion
#region Perform the actual copying for MakeBackup()
DoBackup() {
...
#endregion
#region Make a backup of the current database files and tag with TimeStamp
MakeBackups() {
...
#endregion
#region Restore previously saved DB from given TimeStamp
RestoreSaved() {
...
#endregion
#region Get the size of the given DB in MB
GetSize() {
